...
public class MainWindow extends JFrame {
	...
	private void initGUI() 
	{
		...
		// Spieces Table
		 ...
		 TitledBorder speciesBorder = new TitledBorder(new LineBorder(Color.black, 2), "Species", TitledBorder.LEFT, TitledBorder.TOP, new Font("Arial", Font.BOLD, 14), Color.black);
        ...
        TitledBorder regionsBorder = new TitledBorder(new LineBorder(Color.black, 2), "Regions", TitledBorder.LEFT, TitledBorder.TOP, new Font("Arial", Font.BOLD, 14), Color.black);
